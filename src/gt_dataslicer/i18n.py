...
_MESSAGES: Final[dict[str, dict[str, str]]] = {
    "pt-BR": {
        ...
        "option.output": "Caminho de saída. Sem formato explícito, usa CSV.",
        ...
        "option.summary_output_name": "Nome de saída para cada arquivo de sumarização da fila. Repita na mesma ordem dos arquivos resolvidos.",
        "option.summarize": "Gera arquivo de sumarização agrupada com totais do resultado.",
        "option.summary_only": "Executa apenas a sumarização agrupada com totais, sem exportar base filtrada.",
        "option.summary_group_by": "Colunas para agrupar a sumarização (uma por linha).",
        "option.summary_totals": "Colunas para somar na sumarização (uma por linha).",
    ...
    "en-US": {
        ...
        "option.output": "Output path. Without an explicit format, uses CSV.",
        ...
        "option.summary_output_name": "Summarization output name for each queued file. Repeat in the same order as resolved inputs.",
        "option.summarize": "Generate grouped summarization output with totals for filtered rows.",
        "option.summary_only": "Generate only grouped summarization output with totals, without exporting filtered base.",
        "option.summary_group_by": "Summarization group-by columns, one per line.",
        "option.summary_totals": "Columns to sum in summarization, one per line.",
