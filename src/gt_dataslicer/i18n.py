...
_MESSAGES: Final[dict[str, dict[str, str]]] = {
    ...
    "en-US": {
        ...
        "option.summary_only": "Generate only summary output, without exporting filtered base.",
        "option.summary_group_by": "Summary group-by columns, one per line.",
        "option.summary_totals": "Columns to sum in summary, one per line.",
